...
repositories {
    ...
    strictMaven("https://maven.midnightdust.eu/releases/", "MidnightDust", "eu.midnightdust") // MidnightLib
    strictMaven("https://maven.nucleoid.xyz", "Nucleoid", "eu.pb4", "xyz.nucleoid") // Polymer
...
dependencies {
	...
	modImplementation ("eu.pb4:polymer-blocks:${property("deps.polymer")}")
	modImplementation ("eu.pb4:polymer-resource-pack:${property("deps.polymer")}")
	modImplementation ("eu.pb4:polymer-resource-pack-extras:${property("deps.polymer")}")
	modImplementation ("eu.pb4:polymer-virtual-entity:${property("deps.polymer")}")
	modImplementation ("eu.pb4:polymer-autohost:${property("deps.polymer")}")
	modImplementation ("eu.pb4:factorytools:${property("deps.factorytools")}")

	// MidnightLib
    val midnightlib = "eu.midnightdust:midnightlib:${property("deps.midnightlib")}+${stonecutter.current.version}-fabric"
