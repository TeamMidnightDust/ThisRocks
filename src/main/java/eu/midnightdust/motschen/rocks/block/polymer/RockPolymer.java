...
public class RockPolymer extends Rock implements PolymerBlock, PolymerTexturedBlock, BlockWithElementHolder {
    ...
    public BlockState getPolymerBreakEventBlockState(BlockState state, PacketContext context) {
        return hasModOnClient(PolymerCommonUtils.getPlayer(context)) ? state : Blocks.STONE_BUTTON.defaultBlockState().setValue(BlockStateProperties.ATTACH_FACE, AttachFace.FLOOR);
    }
